  ...
  const handleSubmit = async (e: React.FormEvent, publishNow = false) => {
    ...
    try {
      ...
      const payload = {
        ...
        published: publishNow || formData.is_published,
      ...
      <div className="flex items-center justify-between mb-8">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-gray-500 mt-1">"{post.title}" yazısını düzenliyorsunuz</p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-3">
          ...
          >
            ...
            {saving ? 'Yayınlanıyor...' : formData.is_published ? 'Güncelle' : 'Yayınla'}
          </Button>
        </div>
      </div>
            ...
            <CardContent className="space-y-3">
              ...
              {post.view_count !== undefined && (
                <div className="flex items-center justify-between">
                  ...
                  <Badge variant="outline">{post.view_count}</Badge>
                </div>
              )}
            </CardContent>
          </Card>
